...
namespace KreekCraft
{
    static class Extensions
    {
        ...
        {
			pm.pierce = pierce;
			pm.maxPierce = infiniteMax?99999999:pierce;
			pm.CapPierce(infiniteMax ? 99999999 : pierce);
		...
		{
			dm.damage = damage;
			dm.maxDamage = infiniteMax ? 99999999 : damage;
			dm.CapDamage(infiniteMax ? 99999999 : damage);
